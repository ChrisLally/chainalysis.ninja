...
?>
	...
	<table class="form-table"><!-- Grab a hot cup of coffee, yes we're using tables! -->
		...
		<tr valign="top">
		<a style="margin-top: 20px; background: none #5cb85c;
	border-color: #4cae4c;
	box-shadow: none;
	color: #fff;" href="http://www.codegrape.com/item/bh-custom-preloader/9097" class="button btn-upgrade" target="_blank">Upgrade To Pro »</a>
		...
		<td>
			<p>This option is available on pro version <a style="background: none #5cb85c;
	border-color: #4cae4c;
	box-shadow: none;
	color: #fff;" href="http://www.codegrape.com/item/bh-custom-preloader/9097" class="button btn-upgrade" target="_blank">Upgrade To Pro »</a></p>
